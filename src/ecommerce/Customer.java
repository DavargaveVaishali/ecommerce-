...
//	private Cart customerCart=new Cart();
	...
	public void CustomerPage() throws IOException
	{
		...
		//System.out.println("Products check="+producs_Checks);
		...
		do
		{
			...
			System.out.println("3 - SEACH A PRODUCT TYPEWISE");//completed
			...
			System.out.println("7 - PROCESS TO PAYMENT");//completed
